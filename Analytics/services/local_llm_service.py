...
Integrates with Ollama running LLaMA 3.1 models with FinBERT sentiment enhancement.
Enhanced with sentiment-aware explanation generation and hybrid analysis coordination.
"""
...
class LocalLLMService:
    ...
    @property
    def client(self):
        """Lazy-loaded Ollama client with thread safety."""
...
Use professional investment language with complete sentences."""
    ...
    def _create_sentiment_enhanced_cache_key(self, 
        ...
        if sentiment_data:
            ...
            sentiment_hash = hashlib.md5(sentiment_context.encode()).hexdigest()[:8]

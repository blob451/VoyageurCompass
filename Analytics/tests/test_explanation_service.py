...
class RealExplanationServiceTestCase(TransactionTestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="explanation_test_user", email="explanation@test.com", password="testpass123"
        )

        # Create sector and industry
        self.sector = DataSector.objects.create(
            sectorKey="test_financial", sectorName="Test Financial Services", data_source="yahoo"
        )
    ...
    def test_real_analysis_data_preparation_from_dict(self):
        ...
        mock_dict = {
            ...
            "score_0_10": 8.2,
            "composite_raw": 3.1,
            "weighted_scores": {"w_sma50vs200": 0.12, "w_rsi14": 0.04},
        }
    ...
    def test_real_risk_factors_extraction(self):
        ...
        test_cases = [
            ...
            {"weighted_scores": {"w_rsi14": -0.05}, "expected_risks": ["Potential oversold conditions"]},  # Oversold
            {
                "weighted_scores": {"w_sma50vs200": 0.02, "w_pricevs50": 0.01},  # Uncertain trend
                "expected_risks": ["Trend uncertainty detected"],
            },
            {"weighted_scores": {"w_volsurge": -0.04}, "expected_risks": ["Low trading volume concern"]},  # Low volume
        ]
    ...
    def test_real_indicator_explanation_building(self):
        ...
        for indicator, raw_value, weight, expected_terms in test_cases:
            ...
            for term in expected_terms:
                self.assertIn(
                    term.lower(), explanation_lower, f"Term '{term}' not found in explanation for {indicator}"
                )
    ...
    def test_real_template_explanation_generation_summary(self):
        ...
        analysis_data = {
            ...
            "score_0_10": 7.5,
            "composite_raw": 2.8,
            "weighted_scores": {"w_sma50vs200": 0.15, "w_rsi14": 0.05, "w_macd12269": 0.07},
            "components": {
    ...
    def test_real_template_explanation_generation_detailed(self):
        ...
        analysis_data = {
            ...
            "score_0_10": 8.2,
            "composite_raw": 3.5,
            "weighted_scores": {"w_sma50vs200": 0.15, "w_rsi14": 0.05, "w_macd12269": 0.08, "w_sentiment": 0.07},
            "components": {
        ...
        self.assertTrue(
            any(indicator in content.lower() for indicator in ["moving average", "rsi", "macd", "sentiment"])
        )
    ...
    def test_real_cache_key_creation(self):
        ...
        analysis_data = {
            "symbol": "CACHE_TEST",
            "score_0_10": 6.5,
            "weighted_scores": {"w_sma50vs200": 0.10, "w_rsi14": 0.05},
        }
        ...
        other_user = User.objects.create_user(
            username="other_cache_user", email="other@test.com", password="testpass123"
        )
    ...
    def test_real_explanation_caching(self):
        ...
        explanation = service.explain_prediction_single(self.analysis_result, detail_level="summary")
    ...
    def test_real_error_handling(self):
        ...
        invalid_data = {"symbol": "INVALID", "score_0_10": None, "weighted_scores": {}}
...
class RealExplanationIntegrationTestCase(TransactionTestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="integration_exp_user", email="integration_exp@test.com", password="testpass123"
        )

        # Create comprehensive test stock
        self.stock = Stock.objects.create(
            symbol="FULL_EXPL", short_name="Full Explanation Test", market_cap=75000000000
        )
    ...
    def test_real_explanation_personalization(self):
        ...
        user1 = self.user
        user2 = User.objects.create_user(username="user2_exp", email="user2_exp@test.com", password="testpass123")

        analysis_data = {"symbol": "PERSONAL_TEST", "score_0_10": 7.2, "weighted_scores": {"w_sma50vs200": 0.12}}
    ...
    def test_real_explanation_performance(self):
        ...
        analysis_data = {
            "symbol": "PERF_TEST",
            "score_0_10": 6.8,
            "weighted_scores": {"w_sma50vs200": 0.12, "w_rsi14": 0.05, "w_macd12269": 0.07},
        }
...
if __name__ == "__main__":
    ...
    runner = TestRunner()
    runner.run_tests(["Analytics.tests.test_explanation_service"])

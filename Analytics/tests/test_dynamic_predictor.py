...
class DynamicPredictorTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.sector = DataSector.objects.create(
            sectorKey="tech_dynamic", sectorName="Technology Dynamic", data_source="test"
        )

        self.industry = DataIndustry.objects.create(
            industryKey="software_dynamic", industryName="Software Dynamic", sector=self.sector, data_source="test"
        )

        self.stock = Stock.objects.create(
            symbol="DYN_TEST", short_name="Dynamic Test Corp", sector_id=self.sector, industry_id=self.industry
        )
...
class DynamicPredictorIntegrationTestCase(TransactionTestCase):
    ...
    def setUp(self):
        ...
        self.stock = Stock.objects.create(
            symbol="DYN_INTEG", short_name="Dynamic Integration Corp", sector_id=self.sector, industry_id=self.industry
        )

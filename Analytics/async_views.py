    ...
    request={
        'application/json': {
            ...
            'properties': {
                ...
                'months': {
                    'type': 'integer',
                    'description': 'Number of months for analysis',
                    'default': 6
                }
            },
            'required': ['symbols']
        ...
        'application/json': {
            ...
            'properties': {
                'analysis_data_list': {
                    ...
                    'items': {
                        'type': 'object',
                        'description': 'Analysis data object'
                    },
...
@extend_schema(
    summary="Get async pipeline performance",
    description="Get performance metrics for the async processing pipeline"
)
@api_view(['GET'])
@permission_classes([IsAuthenticated])

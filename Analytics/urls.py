...
urlpatterns = [
    path(
        "indicators/", market_overview, name="indicators"
    ),  # Simple indicators endpoint for performance testing
    ...
    path(
        "technical-indicators/<str:symbol>/", analyze_stock, name="technical-indicators"
    ),
    path("market-sentiment/", market_overview, name="market-sentiment"),
    path(
        "portfolio-analysis/<int:portfolio_id>/",
        analyze_portfolio,
        name="portfolio-analysis",
    ),
    path(
        "risk-assessment/<int:portfolio_id>/", analyze_portfolio, name="risk-assessment"
    ),
    path(
        "stock-recommendations/<str:symbol>/",
        analyze_stock,

...
@extend_schema(
    ...
    description="Get overall code quality metrics for the project"
)
@api_view(['GET'])
...
@extend_schema(
    summary="Get quality recommendations",
    description="Get code quality improvement recommendations"
)
@api_view(['GET'])
@permission_classes([IsAuthenticated])
...
@extend_schema(
    summary="Get quality service status",
    description="Get status and configuration of the code quality service"
)
@api_view(['GET'])
@permission_classes([IsAuthenticated])

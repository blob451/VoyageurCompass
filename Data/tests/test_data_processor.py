...
class DataProcessorTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.sample_price_data = [
            {"date": "2023-01-01", "close": "100.50", "volume": "1000000"},
            {"date": "2023-01-02", "close": "101.25", "volume": "1100000"},
            {"date": "2023-01-03", "close": "99.75", "volume": "900000"},
        ]
...
class DataProcessorIntegrationTestCase(TestCase):
    ...
    def test_complex_data_pipeline(self):
        ...
        correlation = self.processor.calculate_correlations(processed["prices"], processed["volumes"])
    ...
    def test_concurrent_processing(self):
        ...
        chunk_size = 250
        chunks = [self.large_dataset[i : i + chunk_size] for i in range(0, len(self.large_dataset), chunk_size)]

...
class TestStockQuerySet(TestCase):
    ...
    def test_method_chaining_real_active(self):
        ...
        self.assertQuerySetEqual(
            real_active_stocks.order_by("symbol"),
            active_real_stocks.order_by("symbol"),
...
class TestEdgeCases(TestCase):
    ...
    def test_null_data_source_handling(self):
        ...
        stock_empty = Stock.objects.create(
            symbol="EMPTY", short_name="Empty Source", data_source="", is_active=True
        )
    ...
    def test_case_sensitivity(self):
        ...
        stock_upper = Stock.objects.create(
            symbol="UPPER",
            short_name="Upper Mock",
            data_source="MOCK",  # Uppercase
            is_active=True,
        )

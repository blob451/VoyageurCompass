...
class AnalyticsWriterTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.components = {
            "sma50vs200": {"raw": {"sma50": 150.0, "sma200": 140.0}, "normalized": 0.75},
            "sentiment": {
                "raw": {
                    "sentiment": 0.6,
                    "label": "positive",
            ...
            "prediction": {
                "raw": {"predicted_price": 155.50, "confidence": 0.75, "model_version": "lstm_v1.0"},
                "normalized": 0.7,
            },
        }
    ...
    def test_batch_upsert_analytics_results(self):
        ...
        # Create second stock
        stock2 = Stock.objects.create(symbol="TEST2", short_name="Test Company 2", exchange="NYSE")
    ...
    def test_get_analytics_results_range(self):
        ...
        results = self.writer.get_analytics_results_range("TEST", start_date=start_date, end_date=end_date)

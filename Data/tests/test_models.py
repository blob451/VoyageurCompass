...
class TestStockPriceModel(TestCase):
    ...
    def test_create_stock_price(self):
        ...
        stock, _ = Stock.objects.get_or_create(
            symbol="AAPL_PRICE_CREATE", defaults={"short_name": "Apple Price Create Test"}
        )
    ...
    def test_unique_stock_date_constraint(self):
        ...
        stock, _ = Stock.objects.get_or_create(
            symbol="AAPL_DATE_UNIQUE", defaults={"short_name": "Apple Date Unique Test"}
        )
    ...
    def test_daily_change_percent_property(self):
        ...
        stock, _ = Stock.objects.get_or_create(
            symbol="AAPL_CHANGE_PCT", defaults={"short_name": "Apple Change Percent Test"}
        )
        price = StockPrice.objects.create(
            stock=stock,
            date=date.today(),
...
class TestPortfolioModel(TestCase):
    ...
    def test_calculate_returns(self):
        ...
        user = User.objects.create_user(username="testuser", password="testpass")
        portfolio = Portfolio.objects.create(
            user=user, name="My Portfolio", initial_value=Decimal("10000.00"), current_value=Decimal("12000.00")
        )
    ...
    def test_update_value(self):
        ...
        user = User.objects.create_user(username="testuser", password="testpass")
        portfolio = Portfolio.objects.create(user=user, name="My Portfolio", initial_value=Decimal("10000.00"))
...
class TestPortfolioHoldingModel(TestCase):
    ...
    def test_unique_portfolio_stock_constraint(self):
        ...
        portfolio = Portfolio.objects.create(user=user, name="My Portfolio Unique Test")
        stock, _ = Stock.objects.get_or_create(
            symbol="AAPL_HOLDING_UNIQUE", defaults={"short_name": "Apple Holding Unique Test"}
        )

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(blank=True, help_text="Portfolio description"),
                ),
                (
                    "is_active",
                    models.BooleanField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "short_name",
                    models.CharField(
                        blank=True, help_text="Short company name", max_length=100
                    ),
                ),
                (
                    "long_name",
                    models.CharField(
                        blank=True, help_text="Full company name", max_length=255
                    ),
                ),
                (
                    "currency",
                    models.CharField(
                        default="USD", help_text="Trading currency", max_length=10
                    ),
                ),
                (
                    "exchange",
                ...
                (
                    "sector",
                    models.CharField(
                        blank=True, help_text="Business sector", max_length=100
                    ),
                ),
                (
                    "industry",
                    models.CharField(
                        blank=True, help_text="Industry classification", max_length=100
                    ),
                ),
                (
                    "country",
                    models.CharField(
                        blank=True, help_text="Country of headquarters", max_length=50
                    ),
                ),
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Company description/summary"
                    ),
                ),
                (
                    "market_cap",
                    models.BigIntegerField(
                        default=0, help_text="Market capitalization"
                    ),
                ),
                (
                    "shares_outstanding",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["symbol"], name="Data_stock_symbol_8198ba_idx"
                    ),
                    models.Index(
                        fields=["sector", "industry"],
                        name="Data_stock_sector_ae56e8_idx",
                    ),
                    models.Index(
                        fields=["is_active", "symbol"],
                        name="Data_stock_is_acti_964ae7_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Additional notes about this holding"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["stock", "-date"], name="Data_stockp_stock_i_4e3882_idx"
                    ),

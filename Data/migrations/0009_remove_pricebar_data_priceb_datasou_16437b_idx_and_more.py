...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="pricebar",
            index=models.Index(
                fields=["data_source", "stock", "-date"],
                name="Data_priceb_data_so_433c68_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="stock",
            index=models.Index(
                fields=["data_source", "symbol"], name="Data_stock_data_so_3352c2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stock",
            index=models.Index(
                fields=["sectorUpdatedAt"], name="Data_stock_sectorU_93cc14_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stockprice",
            index=models.Index(
                fields=["data_source", "stock", "-date"],
                name="Data_stockp_data_so_7762eb_idx",
            ),
        ),
    ]

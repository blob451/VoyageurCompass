        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "horizon",
                    models.CharField(
                        choices=[("short", "Short"), ("medium", "Medium"), ("long", "Long"), ("blend", "Blend")],
                        default="blend",
                ...
                (
                    "w_rsi14",
                    models.DecimalField(
                        blank=True, decimal_places=6, help_text="Weighted RSI(14) score", max_digits=10, null=True
                    ),
                ),
                (
                    "w_macd12269",
                ...
                (
                    "w_volsurge",
                    models.DecimalField(
                        blank=True, decimal_places=6, help_text="Weighted Volume Surge score", max_digits=10, null=True
                    ),
                ),
                (
                    "w_obv20",
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=6,
                        help_text="Weighted Relative Strength 3Y score",
                        max_digits=10,
                        null=True,
                    ),
                ),
                ...
                (
                    "composite_raw",
                    models.DecimalField(
                        blank=True, decimal_places=6, help_text="Sum of all weighted scores", max_digits=10, null=True
                    ),
                ),
                (
                    "score_0_10",
                    models.IntegerField(blank=True, help_text="Final composite score (0-10, rounded)", null=True),
                ),
            ...
            options={
                ...
                "ordering": ["-as_of"],
                "indexes": [
                    models.Index(fields=["stock", "-as_of"], name="analytics_r_stock_i_526010_idx"),
                    models.Index(fields=["as_of"], name="analytics_r_as_of_bd71b7_idx"),
                    models.Index(fields=["stock", "horizon", "-as_of"], name="analytics_r_stock_i_007d8e_idx"),
                ],

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "industryKey",
                    models.CharField(db_index=True, help_text="Normalized industry key", max_length=100, unique=True),
                ),
                ...
                (
                    "last_sync",
                    models.DateTimeField(blank=True, help_text="Last time industry data was synced", null=True),
                ),
                (
                    "data_source",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "volume_agg",
                    models.BigIntegerField(default=0, help_text="Aggregated volume for sector constituents"),
                ),
                ("constituents_count", models.IntegerField(help_text="Number of stocks included in composite")),
                (
                    "method",
                    models.CharField(
                        choices=[("cap_weighted", "Cap Weighted"), ("equal_weighted", "Equal Weighted")],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "volume_agg",
                    models.BigIntegerField(default=0, help_text="Aggregated volume for industry constituents"),
                ),
                ("constituents_count", models.IntegerField(help_text="Number of stocks included in composite")),
                (
                    "method",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_sync",
                    models.DateTimeField(blank=True, help_text="Last time sector data was synced", null=True),
                ),
                (
                    "data_source",
                    models.CharField(
            ...
            options={
                ...
                "ordering": ["sectorName"],
                "indexes": [
                    models.Index(fields=["sectorKey"], name="data_sector_sectorK_21ffe1_idx"),
                    models.Index(fields=["isActive"], name="data_sector_isActiv_e39f30_idx"),
                ],
            },
        ),
        migrations.AddField(

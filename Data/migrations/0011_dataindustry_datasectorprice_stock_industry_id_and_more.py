...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "industryName",
                    models.CharField(
                        help_text="Human-readable industry name", max_length=200
                    ),
                ),
                (
                    "isActive",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sectorName",
                    models.CharField(
                        help_text="Human-readable sector name", max_length=200
                    ),
                ),
                (
                    "isActive",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["sectorKey"], name="data_sector_sectorK_21ffe1_idx"
                    ),
                    models.Index(
                        fields=["isActive"], name="data_sector_isActiv_e39f30_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="stock",
            index=models.Index(
                fields=["sector_id"], name="Data_stock_sector__0cadae_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stock",
            index=models.Index(
                fields=["industry_id"], name="Data_stock_industr_25e798_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stock",
            index=models.Index(
                fields=["sector_id", "industry_id"],
                name="Data_stock_sector__20bb36_idx",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name="dataindustryprice",
            index=models.Index(
                fields=["industry", "date"], name="data_indust_industr_42e4b9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="dataindustryprice",
            index=models.Index(
                fields=["industry", "-date"], name="data_indust_industr_98c43f_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="dataindustry",
            index=models.Index(
                fields=["industryKey"], name="data_indust_industr_8e64c9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="dataindustry",
            index=models.Index(
                fields=["sector"], name="data_indust_sector__f77910_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="dataindustry",
            index=models.Index(
                fields=["isActive"], name="data_indust_isActiv_59c29f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="datasectorprice",
        ...
        migrations.AddIndex(
            model_name="datasectorprice",
            index=models.Index(
                fields=["sector", "date"], name="data_sector_sector__61f6b7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="datasectorprice",
            index=models.Index(
                fields=["sector", "-date"], name="data_sector_sector__99b5c3_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="datasectorprice",

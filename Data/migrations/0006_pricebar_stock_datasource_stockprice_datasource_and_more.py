    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateTimeField(db_index=True, help_text="Bar timestamp"),
                ),
                (
                    "interval",
                    models.CharField(
        ...
        migrations.AddIndex(
            model_name="stock",
            index=models.Index(
                fields=["dataSource", "symbol"], name="Data_stock_dataSou_8c6a2e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stockprice",
            index=models.Index(
                fields=["dataSource", "stock", "-date"],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="Data_priceb_stock_i_7a0e15_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="pricebar",

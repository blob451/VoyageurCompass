...
class StockPriceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StockPrice
        fields = ["id", "date", "open", "high", "low", "close", "adjusted_close", "volume", "daily_range", "is_gain"]
    ...
    def create(self, validated_data):
        ...
        if stock_symbol:
            try:
                ...
                raise serializers.ValidationError({"stock_symbol": f"Stock with symbol {stock_symbol} not found"})

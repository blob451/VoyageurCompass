...
class YahooFinanceMocks:
    ...
    def get_market_status_success():
        ...
        return {
            ...
            "indicators": {"spy": 450.25, "vix": 18.5},
...
def mock_yahoo_finance_success(func):
    ...
    return patch(
        "Data.services.yahoo_finance.yahoo_finance_service.get_stock_data",
        return_value=YahooFinanceMocks.get_stock_data_success(),
    )(func)
...
def mock_yahoo_finance_market_status(func):
    ...
    return patch(
        "Data.services.yahoo_finance.yahoo_finance_service.get_market_status",
        return_value=YahooFinanceMocks.get_market_status_success(),
    )(func)
...
def mock_yahoo_finance_validation(func):
    ...
    return patch(
        "Data.services.yahoo_finance.yahoo_finance_service.validate_symbol",
        return_value=True,
    )(func)

...
class DatabaseConfigurationTestCase(TestCase):
    ...
    def test_basic_model_operations(self):
        ...
        # Test creation
        user = User.objects.create_user(username="test_db_config", email="test@example.com", password="testpass123")
...
class EnvironmentDetectionTestCase(unittest.TestCase):
    ...
    def test_database_url_parsing(self):
        ...
        with unittest.mock.patch.dict(os.environ, {"CI": "true", "DATABASE_URL": test_url}):
            import importlib

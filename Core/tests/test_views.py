...
class UtilityEndpointsTestCase(APITestCase):
    ...
    def test_server_time(self):
        ...
        server_time = datetime.fromisoformat(
            response.data["server_time"].replace("Z", "+00:00")
        )
...
class RateLimitingTestCase(APITestCase):
    ...
    def test_rate_limiting(self):
        ...
        with patch(
            "rest_framework.throttling.AnonRateThrottle.get_rate"
        ) as mock_get_rate:
        ...
        self.assertIn(
            "anon", throttle_rates, "Anonymous rate limiting should be configured"
        )
